...
class MyFrame(wx.Frame):
    ...
    def __do_layout(self):
        ...
        delareuppe.Add(self.elev, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
        delareuppe.Add(self.stod, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
        ram2.Add(delareuppe, 0, wx.EXPAND, 0)
        delarenere.Add(self.namnruta, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
        delarenere.Add(self.OK, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
        delarenere.Add(self.Visanamn, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
        ram2.Add(delarenere, 0, wx.EXPAND, 0)
        topram.Add(ram2, 0, wx.EXPAND, 0)
